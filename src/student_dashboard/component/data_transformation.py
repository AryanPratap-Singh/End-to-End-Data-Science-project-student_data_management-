...
class data_transformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            input_feature_train_df = trian_df.drop(columns=[target_column_name], axis=1)
            target_feature_train_df = trian_df[target_column_name]
            
            input_feature_test_df = trian_df.drop(columns=[target_column_name], axis=1)
            target_feature_test_df = trian_df[target_column_name]
